DROP TABLE IF EXISTS users, categories, locations, events, requests, compilations, compilations, compilation_events, comments CASCADE;
...
(
    ...
    CONSTRAINT pl_comments PRIMARY KEY (id),
    ...
    CONSTRAINT check_comment_text_len CHECK (LENGTH(text) >= 20 AND LENGTH(text) <= 2000)
    );