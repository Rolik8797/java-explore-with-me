...
public class PrivateEventController {
    ...
    public EventFullDto createEvents(
            @PathVariable Long userId,
    ...
    @GetMapping("/{eventId}")
    public EventFullDto getEventsByUserId(
            @PathVariable Long userId,
    ...
    public EventFullDto updateEventsByUser(
            @PathVariable Long userId,
            @PathVariable Long eventId,
    ...
    public List<ParticipationRequestDto> getRequestUserEvents(
            @PathVariable Long userId,
            @PathVariable Long eventId
    ) {
